	...
	public $elements = [
		...
		'filter' => [
			...
			'b4_registration_payment_received' => [
				...
				'b4_registration_can_volunteer1' => ['order' => 2, 'label_name' => 'Volunteer', 'type' => 'boolean', 'percent' => 50, 'method' => 'multiselect', 'multiple_column' => 1, 'options_model' => '\Object\Data\Model\Inactive', 'query_builder' => 'a.b4_registration_can_volunteer;=']
			],
			'full_text_search' => [
