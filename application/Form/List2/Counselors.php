...
class Counselors extends \Object\Form\Wrapper\List2 {
	...
	public $elements = [
		...
		'filter' => [
			...
			'b4_counselor_period_id' => [
				'b4_counselor_period_id1' => ['order' => 1, 'row_order' => 200, 'label_name' => 'Period', 'domain' => 'group_id', 'null' => true, 'default' => 'dependent::100', 'percent' => 50, 'placeholder' => \Object\Content\Messages::PLEASE_CHOOSE, 'method' => 'select', 'options_model' => '\Model\Periods', 'query_builder' => 'a.b4_counselor_period_id;='],
	...
	public function processDefaultValue(& $form, $key, $default, & $value, & $neighbouring_values, $changed_field = [], $options = []) {
		if ($key == 'b4_counselor_period_id1') {
			if (empty($value) && empty($neighbouring_values['b4_counselor_period_id1'])) {
				...
				if (!empty($temp['b4_period_id'])) {
					$neighbouring_values['b4_counselor_period_id1'] = $value = $temp['b4_period_id'];
				}
			}
		}
	}
