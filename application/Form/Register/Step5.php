		...
		if (!empty($error)) {
			...
			$options = [
				...
				'options' => [
					...
					i18n(null, "Any questions?  [phone] or <a href=\"mailto:[email]\">[email]</a>", ['replace' => ['[phone]' => \Application::get('application.b4j.contact.phone'), '[email]' => \Application::get('application.b4j.contact.email')]])
				]
			];
